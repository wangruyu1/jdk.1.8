...
/**
 * 保证自然顺序(插入或者(插入和更新,查询))的map,继承自HashMap(只是在hashmap的Node基础上加了一个前向节点和后向节点)
 *
 */
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {

	/**
	 * 在hashmap的Node基础上加了一个前向节点和后向节点,用来保证节点的顺序
	 */
	...
	/**
	 * 更新或者查询数据时,是否改变当前节点的顺序(改变则变为尾节点)
	 *
	 * @serial
	 */
	...
	/**
	 * 现在没用(removeEldestEntry返回false)，不清楚使用场景
	 */
	 ...
	 * does not support the <tt>add</tt> or <tt>addAll</tt> operations. Its
	 * {@link Spliterator} typically provides faster sequential performance but
	 * much poorer parallel performance than that of {@code HashMap}.
	 *
